...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_errors(self):
        ...
        new_user = create_user(email="ebraheem@gmail.com", password="test123")
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        """test try to delete another users recipe gives another error"""
        new_user = create_user(email="ebraheem@example.cm", password="test123")
